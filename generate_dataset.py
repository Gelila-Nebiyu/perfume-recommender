...
perfume_names = [
    ...
    "YSL Libre", "Gucci Bloom", "Lancome La Vie Est Belle", "Maison Margiela Replica Jazz Club",
    "Byredo Gypsy Water", "Chloe Nomade", "Armani Si", "Versace Eros", "Prada Candy",
    "Bvlgari Omnia Crystalline", "Hermes Terre d'Hermes", "Givenchy L'Interdit", "Montblanc Explorer",
    "Penhaligon's Juniper Sling", "Amouage Reflection", "Narciso Rodriguez For Her", "Le Labo Santal 33",
    "Diptyque Philosykos", "Tiziana Terenzi Kirke", "Atelier Cologne Clementine California",
    "Frederic Malle Portrait of a Lady", "Guerlain Mon Guerlain", "Maison Francis Kurkdjian Baccarat Rouge 540",
    ...
    "Creed Silver Mountain Water", "Hermes Un Jardin Sur Le Nil", "Lancome Tresor",
    "Guerlain Shalimar", "Armani Code", "Versace Bright Crystal", "Prada La Femme", "Bvlgari Goldea"
]
brands = ["Chanel", "Dior", "Creed", "Tom Ford", "Jo Malone", "YSL", "Gucci", "Lancome", "Maison Margiela",
          "Byredo", "Chloe", "Armani", "Versace", "Prada", "Bvlgari", "Hermes", "Givenchy", "Montblanc",
          "Penhaligon's", "Amouage", "Narciso Rodriguez", "Le Labo", "Diptyque", "Tiziana Terenzi",
          "Atelier Cologne", "Frederic Malle", "Guerlain", "Maison Francis Kurkdjian", "Acqua di Parma",
          "L'Artisan Parfumeur", "Dolce & Gabbana", "Burberry", "Viktor & Rolf", "Jean Paul Gaultier",
          "Aesop"]
...
# Generate synthetic dataset with balanced genders
np.random.seed(42)
n_samples = 100
data = {
    "perfume_name": np.random.choice(perfume_names, n_samples, replace=True),
    "brand": np.random.choice(brands, n_samples),
    "gender": np.random.choice(genders, n_samples, p=[0.34, 0.33, 0.33]),  # Balanced distribution
    "scent_type": np.random.choice(scent_types, n_samples),
